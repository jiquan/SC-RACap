...
def train(dataset, model, args):
    ...
    for epoch in range(epochs):
        ...
        sys.stdout.flush()
        metric_logger = utils.MetricLogger(delimiter="  ", log_file='training_log.txt')
        ...
        averaged_stats = metric_logger.global_avg()
        print("Averaged stats:", averaged_stats)
        with open('train.txt', 'a') as f:
            # Write the formatted string to the file
            f.write(f"Averaged stats: {averaged_stats}\n")
